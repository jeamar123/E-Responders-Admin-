        <header class="header">
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="navbar-right" style="min-width: 28%;" >
                    <ul class="nav navbar-nav" style="min-width: 90%;">
                        ...
                        <li class="dropdown user user-menu pull-right" style="min-width: 48%;">
                            <a href="" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="<?php echo base_url('assets/img/avatar3.png') ?>" class="img-circle" alt="User Image" />
                                    <p>
                                        <span full-name></span> - Web Developer
