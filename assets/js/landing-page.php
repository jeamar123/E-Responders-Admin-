                    ...
                    <div class="modal-body">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input class="form-control form-input color-black" type="text" ng-model="user.username" name="username" placeholder="Enter username">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input class="form-control form-input color-black" type="password" ng-model="user.password" name="password" placeholder="Enter password">
                            </div>
                        </form>                     
